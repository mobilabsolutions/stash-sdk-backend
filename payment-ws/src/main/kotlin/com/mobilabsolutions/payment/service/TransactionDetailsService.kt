...
class TransactionDetailsService(
    ...
    fun getTransactionsByActionAndStatus(merchantId: String, transactionId: String): TransactionDetailListResponseModel {
        merchantRepository.getMerchantById(merchantId)
            ?: throw ApiError.ofErrorCode(ApiErrorCode.MERCHANT_NOT_FOUND).asException()
        val transactions = transactionRepository.getByTransactionIdAndActionAndStatus(transactionId, TransactionAction.REFUND.name, TransactionStatus.SUCCESS.name)
