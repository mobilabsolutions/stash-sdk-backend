...
class BsPayonePspTest {
    ...
    fun `preauthorize with wrong payment method`() {
        Assertions.assertThrows(ApiException::class.java) {
            bsPayonePsp.preauthorize(PspPaymentRequestModel(correctCcAliasId, AliasExtraModel(null, null, null, PersonalDataModel(null, null, null, lastName, null, null, city, country, null), PaymentMethod.PAY_PAL, null), PaymentDataRequestModel(amount, currency, reason), pspAlias, pspConfig), test)
        }
    }
    ...
    fun `authorize with wrong payment method`() {
        Assertions.assertThrows(ApiException::class.java) {
            bsPayonePsp.authorize(PspPaymentRequestModel(correctCcAliasId, AliasExtraModel(null, null, null, PersonalDataModel(null, null, null, lastName, null, null, city, country, null), PaymentMethod.PAY_PAL, null), PaymentDataRequestModel(amount, currency, reason), pspAlias, pspConfig), test)
        }
    }
